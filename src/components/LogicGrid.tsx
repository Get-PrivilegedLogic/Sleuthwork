...
export default function LogicGrid({ suspects, weapons, locations, grid, onCellClick }: LogicGridProps) {
  ...
  const getCellValue = (row: string, col: string): GridCell => {
  ...
  const renderCell = (value: GridCell) => {
    if (value === 'check') {
